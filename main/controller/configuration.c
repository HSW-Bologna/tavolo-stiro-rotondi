...
#define NUM_WATCHED_PARAMETERS 23


static const char *STEP_SOFFIO_KEY                = "VELSOFFIO";
static const char *BOARD_TEMPERATURE_CONTROL_KEY  = "BOARDTEMP";
...
static const char *HEIGHT_REGULATION_PRESET_4_KEY = "HEIGHTREG4";
static const char *SHAPE_HEIGHT_PRESET_1_KEY      = "SHAPEHEIGHT1";
static const char *SHAPE_HEIGHT_PRESET_2_KEY      = "SHAPEHEIGHT2";
static const char *SHAPE_HEIGHT_PRESET_3_KEY      = "SHAPEHEIGHT3";
static const char *SHAPE_HEIGHT_PRESET_4_KEY      = "SHAPEHEIGHT4";
...
void configuration_init(model_t *pmodel) {
    ...
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.board_temperature_control, storage_save_uint8, BOARD_TEMPERATURE_CONTROL_KEY);
    ...
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.user_height_presets[0], storage_save_uint16, HEIGHT_REGULATION_PRESET_1_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.user_height_presets[1], storage_save_uint16, HEIGHT_REGULATION_PRESET_2_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.user_height_presets[2], storage_save_uint16, HEIGHT_REGULATION_PRESET_3_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.user_height_presets[3], storage_save_uint16, HEIGHT_REGULATION_PRESET_4_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.shape_height_presets[0], storage_save_uint16, SHAPE_HEIGHT_PRESET_1_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.shape_height_presets[1], storage_save_uint16, SHAPE_HEIGHT_PRESET_2_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.shape_height_presets[2], storage_save_uint16, SHAPE_HEIGHT_PRESET_3_KEY);
    watched_parameters[i++] =
        WATCHER(&pmodel->configuration.shape_height_presets[3], storage_save_uint16, SHAPE_HEIGHT_PRESET_4_KEY);
    watched_parameters[i++] = WATCHER_DELAYED(&pmodel->configuration.user_height_presets, storage_save_uint16,
    ...
    storage_load_uint8(&pmodel->configuration.board_temperature_control, (char *)BOARD_TEMPERATURE_CONTROL_KEY);
    ...
    storage_load_uint16(&pmodel->configuration.user_height_presets[0], (char *)HEIGHT_REGULATION_PRESET_1_KEY);
    storage_load_uint16(&pmodel->configuration.user_height_presets[1], (char *)HEIGHT_REGULATION_PRESET_2_KEY);
    storage_load_uint16(&pmodel->configuration.user_height_presets[2], (char *)HEIGHT_REGULATION_PRESET_3_KEY);
    storage_load_uint16(&pmodel->configuration.user_height_presets[3], (char *)HEIGHT_REGULATION_PRESET_4_KEY);
    storage_load_uint16(&pmodel->configuration.selected_user_height_preset, (char *)SELECTED_HEIGHT_PRESET_KEY);
    storage_load_uint16(&pmodel->configuration.shape_height_presets[0], (char *)SHAPE_HEIGHT_PRESET_1_KEY);
    storage_load_uint16(&pmodel->configuration.shape_height_presets[1], (char *)SHAPE_HEIGHT_PRESET_2_KEY);
    storage_load_uint16(&pmodel->configuration.shape_height_presets[2], (char *)SHAPE_HEIGHT_PRESET_3_KEY);
    storage_load_uint16(&pmodel->configuration.shape_height_presets[3], (char *)SHAPE_HEIGHT_PRESET_4_KEY);
