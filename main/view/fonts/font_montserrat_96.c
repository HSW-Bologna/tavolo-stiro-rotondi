...
#ifndef FONT_MONTSERRAT_96
#define FONT_MONTSERRAT_96 1
#endif

#if FONT_MONTSERRAT_96
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 1032, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 2964, .adv_w = 568, .box_w = 26, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3835, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 5569, .adv_w = 879, .box_w = 51, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 7303, .adv_w = 1028, .box_w = 61, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 9347, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 11081, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 12910, .adv_w = 919, .box_w = 52, .box_h = 67, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 14652, .adv_w = 989, .box_w = 54, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 16515, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 18344, .adv_w = 644, .box_w = 32, .box_h = 31, .ofs_x = 4, .ofs_y = 36}
};
...
static const int8_t kern_class_values[] =
{
    ...
    0, 0, 0, 0, -8, -8, 0, -15,
    -18, 0, 0, -23, 15, 0, -38, -5,
    -18, 0, -5, -72, 15, -11, -46, 0,
    0, 0, -8, -8, 0, -8, -20, 0,
    0, -18, 8, 0, 0, 0, 0, 0,
    0, -11, 0, 0, -29, -77, -31, 15,
    0, -12, -100, -28, 0, -28, 0, 9,
    0, 5, 66, 46, 26, -61, 11, 65,
    0, 57, 0
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t font_montserrat_96 = {
#else
lv_font_t font_montserrat_96 = {
#endif
